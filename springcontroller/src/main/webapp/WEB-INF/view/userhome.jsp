...
<div class="col-md-4">
<figure class="figure">
<img src="${image}${product.productid}.jpg" class="rounded" height="300" width="300"/>
 <figcaption class="figure-caption">${product.productName }<br>$${product.price}<br>
<div>
 ...
 <c:url value="cart" var="gotocart"/>
<input type='submit' value='add to cart' href='${gotocart}'/> 
