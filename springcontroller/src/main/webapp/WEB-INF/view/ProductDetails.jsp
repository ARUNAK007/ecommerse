...
<div class="container" >
<h2 style="padding: 1% 30%" >Enter Product Details</h2>
<form method="post" action="addproduct" style="padding: 3% 30%" modelAttribute="addproduct" enctype="multipart/form-data">
<div class="form-group">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <input type="textarea" class="form-control"  placeholder="Enter description" name="description" required>
    </div>
    <div class="form-group">
...
<td>
<a class="btn btn-primary"  href="ProductDetails?productid=${product.productid}">edit</a>
<a class="btn btn-primary" href='deleteproduct?productid=${product.productid}'>delete</a>
</td>
</tr>
</tbody>
</c:forEach>
