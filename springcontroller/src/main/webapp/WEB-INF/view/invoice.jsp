...
<label><h1><center><tr><td>Total amount :</td><td>${carttotal}</td></tr></center></h1> </label>
<label><h1><center><tr><td>Shipping Address :</td><td>${shippingaddress}</td></tr></center></h1></label><br>  
<center><a type="submit"  class="btn btn-primary btn-lg"  href="userhome">Proceed</a></center>
</body>
</html>